...
function Aside() {
  ...
  return (
    <>
      <aside
        className={`lg:w-1/5 md:w-[300px] w-1/2 m-w-[300px] z-30 h-full p-6 bg-neutral-950 lg:block border-r lg:translate-x-0 border-gray-100/40 shadow-inner relative transition-all ${showAside ? 'translate -translate-x-full' : 'md:translate-x-0'}`}
      >
